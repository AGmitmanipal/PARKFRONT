...
export const ENV = Object.freeze({
  // Backends
  ZONES_API_BASE_URL: (() => {
    const url = urlEnv("VITE_ZONES_API_BASE_URL", {
      fallbackForDev: "http://localhost:5000",
    });
    // DEBUG: Log the resolved URL at module load time
    console.log("🔍 DEBUG [env.js]: ZONES_API_BASE_URL resolved to:", url);
    console.log("🔍 DEBUG [env.js]: VITE_ZONES_API_BASE_URL raw value:", import.meta.env.VITE_ZONES_API_BASE_URL);
    return url;
  })(),
